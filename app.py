...
input_features = [
    ...
    'house_age', 'age_since_renovation', 'is_renovated',
]
...
bedrooms = st.number_input("Bedrooms (0–33)", min_value=0, max_value=33, value=3)
...
house_age = st.number_input("House Age (0–115)", min_value=0, max_value=115, value=20)  
